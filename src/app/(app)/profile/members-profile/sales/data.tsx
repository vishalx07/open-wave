...
export const TABS: {
...
}[] = [
  {
    label: "All",
    value: "all",
    href: APP_ROUTES.profile.membersProfile.sales.root,
    count: 66,
  },
  {
    label: "Users",
    value: "users",
    href: APP_ROUTES.profile.membersProfile.sales.tab("users"),
    count: 99,
  },
  {
    label: "My Referrals",
    value: "referrals",
    href: APP_ROUTES.profile.membersProfile.sales.tab("referrals"),
    count: 34,
  },
];
